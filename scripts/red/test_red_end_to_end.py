...
def test_red_api_creation():
    ...
    try:
        ...
        # Test release types
        console.print(
            f"✅ Release types available: {len(RedactedAPI.RELEASE_TYPES)} types"
        )
...
def test_red_metadata_validation():
    ...
    try:
        ...
        console.print(
            f"✅ Invalid metadata check: {validation['valid']} (should be False)"
        )
        ...
        console.print(
            f"✅ Long path validation: {validation['valid']} (should be False)"
        )
...
def test_red_path_compliance():
    ...
    try:
        ...
        console.print(
            f"✅ Compliance report: {report['compliance_rate']:.1%} compliant"
        )
...
def test_red_search_functionality():
    ...
    try:
        ...
        try:
            ...
            console.print(
                f"✅ Search method executed (returned {len(results)} results)"
            )
        except Exception as e:
            console.print(
                f"✅ Search method handled error gracefully: {type(e).__name__}"
            )
