...
def test_path_validation():
    ...
    try:
        ...
        test_cases = [
            ...
            (
                "/some/very/long/absolute/path/that/is/really/really/long/and/goes/on/forever/" + "A" * 160,
                False,
        ...
        console.print(f"• RED folder name limit: {red_api.config.max_path_length} characters")
        console.print(f"• Your audiobook folder: 94 characters ✅")
        console.print(f"• Warning threshold: {int(red_api.config.max_path_length * 0.9)} characters (90%)")
