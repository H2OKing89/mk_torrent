...
def test_audiobook_processor():
    ...
    sample_file = Path("tests/samples/audiobook/How a Realist Hero Rebuilt the Kingdom - vol_03 (2023) (Dojyomaru) {ASIN.B0C8ZW5N6Y} [H2OKing]/How a Realist Hero Rebuilt the Kingdom - vol_03 (2023) (Dojyomaru) {ASIN.B0C8ZW5N6Y}.m4b")
    ...
    try:
        ...
        print(f"   Test validation: valid={test_validation.valid}, completeness={test_validation.completeness:.1%}")
