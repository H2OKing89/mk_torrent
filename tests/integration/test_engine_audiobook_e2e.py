...
AUDIOBOOK_SAMPLE_DIR = SAMPLES_DIR / "audiobook" / "How a Realist Hero Rebuilt the Kingdom - vol_03 (2023) (Dojyomaru) {ASIN.B0C8ZW5N6Y} [H2OKing]"
AUDIOBOOK_SAMPLE_FILE = AUDIOBOOK_SAMPLE_DIR / "How a Realist Hero Rebuilt the Kingdom - vol_03 (2023) (Dojyomaru) {ASIN.B0C8ZW5N6Y}.m4b"
...
class TestMetadataIntegration:
    ...
    def test_validation_failure(self):
        ...
        assert result["success"] is True  # Pipeline succeeds even with validation issues
        validation = result["validation"]
