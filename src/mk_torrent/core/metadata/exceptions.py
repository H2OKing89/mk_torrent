...
class SourceUnavailable(MetadataError):
    ...
    def __init__(self, source_name: str, reason: str, details: Optional[Dict[str, Any]] = None):
...
class MetadataConflict(MetadataError):
    ...
    def __init__(self, field: str, conflicting_values: Dict[str, Any], details: Optional[Dict[str, Any]] = None):
...
class ValidationError(MetadataError):
    ...
    def __init__(self, errors: List[str], warnings: Optional[List[str]] = None, details: Optional[Dict[str, Any]] = None):
...
class ExtractionError(MetadataError):
    ...
    def __init__(self, source: str, reason: str, details: Optional[Dict[str, Any]] = None):
