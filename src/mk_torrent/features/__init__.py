...
from ..core.metadata import (
    MetadataEngine as NewMetadataEngine,
    process_metadata as new_process_metadata,
)

# Legacy compatibility - import old metadata engine
try:
    from .metadata_engine import (
        MetadataEngine as LegacyMetadataEngine,
        ...
        try:
            ...
            if result.get("success"):
                ...
                if self._legacy_engine:
                    return self._legacy_engine.process_metadata(
